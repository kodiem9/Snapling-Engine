...
release:
	g++ -O2 -I $(INCLUDE_PATH) $(SOURCE_FILES) -std=c++$(CPP_VERSION) -L $(INCLUDE_PATH) -framework CoreVideo -framework IOKit -framework Cocoa -framework GLUT -framework OpenGL $(INCLUDE_PATH)$(LIBRARY_PATH) -o $(PROGRAM_NAME)  &&  ./$(PROGRAM_NAME)
